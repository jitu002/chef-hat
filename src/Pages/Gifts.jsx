    ...
    return(
        <div>
            <Center>
                ...
                <Center fontFamily="cinzel"  h='200px'>
                    <Text color="#1A365D" fontSize={{lg:"5xl",md:"3xl",base:"xl"}}>Meal Kit Delivery Gifts <br /> & Gift Cards</Text>
                </Center>
                </div>
            </Center>
            <div>
                <Box fontFamily="cinzel" bg={"blue.900"} height={{lg:"45vh",md:"35vh",base:"28vh"}} borderRadius={"lg"} maxW={"lg"} paddingTop="5%" marginTop="5%" marginLeft={{lg:"10%",md:"10%",base:"0"}}>
                    <Text color="white" fontSize={{lg:"3xl",md:"xl",base:"md"}}>$140 <br />MEAL E-GIFT CARD</Text>
                    <Avatar marginLeft="82%" marginTop="10%" src={chefhat}  />
                </Box>
                <div className="terms">
                    <Center><Text textDecoration="underline" fontFamily="poetsen one" fontSize={{lg:"3xl",md:"2xl",base:"xl"}}>Terms</Text></Center>    
                    <ul>
