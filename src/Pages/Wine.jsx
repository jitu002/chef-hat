...
import bottle from "../Resources/wine/bottle.png"
        ...
        <div>
            <div className="body1">
                <div className="welcome1">
                    ...
                    <Text color="#00A3C4"  fontSize={{lg:"xl",md:"lg",base:"md"}}>
            ...
            <Center>
                <Box width="100%">
                    <Text fontFamily="Audiowide" fontSize={{lg:"4xl",md:"2xl",base:"lg"}} marginBottom="5%">How It Works</Text>
                    <SimpleGrid columns={[1, null, 3]} spacing='40px' marginBottom="5%">
                        <Container fontFamily="Audiowide" fontSize={{lg:"2xl",md:"xl",base:"lg"}}><Avatar src={incredible} size="2xl" /><br />Get exclusive access <br /> to delicious wines from renowned wine-makers</Container>
                        <Container fontFamily="Audiowide" fontSize={{lg:"2xl",md:"xl",base:"lg"}}><Avatar src={monthly} size="2xl" /><br />Select the wines you love. <br />No commitment.Skipping or cancelling is easy</Container>
                        <Container fontFamily="Audiowide" fontSize={{lg:"2xl",md:"xl",base:"lg"}}><Avatar src={sized} size="2xl" /><br />Enjoy paired size wines(500ml), <br />perfect for two to share, or upgrade to standard-sized bottles(750ml)</Container>
                    </SimpleGrid>
                </Box>
            </Center>
            <div className='delivery'>
                <Center>
                    <Card fontFamily="Audiowide" maxW={{lg:'lg',md:'md',base:'sm'}} marginLeft={{base:"20%"}} marginRight={{md:"15%"}} bg={'white'}>
                    <CardBody>
            ...
            <div>
                <Text textDecoration="underline" fontFamily="Audiowide" fontSize={{lg:"4xl",md:"2xl",base:"lg"}} marginTop="5%" marginBottom="1%">From Our Vineyard to Your Doorsteps </Text>
                <Text fontFamily="Audiowide" fontSize={{lg:"xl",md:"lg",base:"md"}} marginBottom="1%">By cutting out the middlemen, we are able to offer you high quality wines at great prices</Text>
                <Center>
                <Image src={vineyard} width={{lg:"60%",md:"80%",base:"100%"}} height={{lg:"300px",md:"225px",base:"150px"}} alt='Vinaeyard process image' />
                </Center>
            </div>
            <div className='favorite'>  
                    <Text fontFamily="Audiowide" color="white" fontSize={{lg:"3xl",md:"2xl",base:"xl"}} marginBottom="2%">Discover your favorites</Text>
                    <Container fontFamily="Audiowide" color="white" fontSize={{lg:"xl",md:"lg",base:"md"}}>Don't know your Pinot Noir from your Pinotage.Our wines come with tasting notes,flavor profiles, and the story behind the bottle to give you the confidence to select the right wine for any occasion and inspire a lifelong love of wine</Container>
            </div>
            <div>
                <Heading fontFamily="Audiowide" fontSize={{lg:"5xl",md:"3xl",base:"xl"}} marginTop="7%">Our Chef Hat wines are specially curated to compliment your Chef Hat delicacies.</Heading>
                <SimpleGrid marginTop="2%" columns={[1,null,3]} spacingX='30px' spacingY='20px'>
                    <Grid templateColumns='repeat(1, 1fr)'>
                        <Box>
                            <Image src={beef} />
                            <Text fontFamily="Audiowide" fontSize={{lg:"5xl",md:"3xl",base:"xl"}}>Calabrian Beef & Gnocchi</Text>
                            <Container fontFamily="Audiowide" fontSize={{lg:"xl",md:"lg",base:"md"}} >
                                Complete the richness of this hearty beef gnocchi dish  with a warming,spicy Chianti drink.
                            </Container>
                        </Box>
                        <Box>
                            <Image src={sauce} />
                            <Text fontFamily="Audiowide" fontSize={{lg:"5xl",md:"3xl",base:"xl"}}>Sheet Pan Pork & Sour Cherry Sauce</Text>
                            <Container fontFamily="Audiowide" fontSize={{lg:"xl",md:"lg",base:"md"}} >
                    ...
                    <Box>
                            <Image src={potato} />
                            <Text fontFamily="Audiowide" fontSize={{lg:"5xl",md:"3xl",base:"xl"}}>Pork Chorizo, Potato & Fig Bake</Text>
                            <Container fontFamily="Audiowide" fontSize={{lg:"xl",md:"lg",base:"md"}} >
                        ...
                        <Box>
                            <Image src={chop} />
                            <Text fontFamily="Audiowide" fontSize={{lg:"5xl",md:"3xl",base:"xl"}}>Hoisin-Glazed Pork Chops   </Text>
                            <Container fontFamily="Audiowide" fontSize={{lg:"xl",md:"lg",base:"md"}} >
            ...
            <div className="glass">
                <Text color="white"fontFamily="Audiowide" fontSize={{lg:"5xl",md:"3xl",base:"xl"}}>Let's Raise a Glass</Text>
